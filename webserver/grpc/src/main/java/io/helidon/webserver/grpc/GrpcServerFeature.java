...
class GrpcServerFeature implements ServerFeature {
    ...
    public void setup(ServerFeatureContext featureContext) {
        ...
        List<GrpcRouteRegistration> routes = this.routes.get();
        for (GrpcRouteRegistration route : routes) {
            ...
            GrpcRouting.Builder builder = routingBuilders.routingBuilder(GrpcRouting.Builder.class, GrpcRouting::builder);
