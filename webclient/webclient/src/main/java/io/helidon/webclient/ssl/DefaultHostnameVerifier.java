 ...
 *
 * From Apache HTTP Client version 4.5.5.
 */
public final class DefaultHostnameVerifier implements HostnameVerifier {
    private static final Logger LOGGER = Logger.getLogger(DefaultHostnameVerifier.class.getName());
    ...
    public static DefaultHostnameVerifier create() {
...
//
//    private DefaultHostnameVerifier(final PublicSuffixMatcher publicSuffixMatcher) {
