...
final class Types {
    ...
    static final TypeName JSON_DATE_FORMAT = TypeName.create("io.helidon.json.binding.Json.DateFormat");
    static final TypeName JSON_NUMBER_FORMAT = TypeName.create("io.helidon.json.binding.Json.NumberFormat");
