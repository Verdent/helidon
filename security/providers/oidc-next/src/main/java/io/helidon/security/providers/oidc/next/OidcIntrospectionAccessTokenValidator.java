...
final class OidcIntrospectionAccessTokenValidator implements OidcAccessTokenValidator {
    ...
    private OidcValidationResult<OidcValidatedAccessToken> validateResponse(OidcAccessTokenValidationRequest request,
        ...
        try {
             ...
             * Quote: "The server responds with a JSON object [RFC7159] in `application/json` format with the following
             * top-level members."
             */
    ...
    private HttpClientResponse request(WebClient webClient,
        ...
        Parameters.Builder form = Parameters.builder("oidc-introspection-form")
                .add("token", token)
