...
public interface JsonBindingConfigurator {
    ...
    <T> JsonDeserializer<T> getDeserializer(GenericType<T> type, JsonContext jsonContext);
    ...
    <T> JsonSerializer<T> getSerializer(GenericType<T> type, JsonContext jsonContext);
