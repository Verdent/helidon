...
/**
 * Helidon JSON Code Generation.
 * Provides annotation processors for generating JSON serialization
 * and deserialization code at compile time.
 */
module io.helidon.json.codegen {
