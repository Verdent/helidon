...
:helidon-version: 4.4.0-SNAPSHOT
...
:grpc-api-javadoc-base-url: {javadoc-base-url}/io.helidon.grpc.api
:grpc-server-javadoc-base-url: {javadoc-base-url}/io.helidon.webserver.grpc
:grpc-client-javadoc-base-url: {javadoc-base-url}/io.helidon.webclient.grpc
:health-javadoc-base-url: {javadoc-base-url}/io.helidon.health.checks
:http-javadoc-base-url: {javadoc-base-url}/io.helidon.http
:integration-eureka-javadoc-base-url: {javadoc-base-url}/io.helidon.integrations.eureka
...
:eureka-client-javadoc-base-url: {javadoc-io-base-url}/com.netflix.eureka/eureka-client/{version-lib-eureka-client}
