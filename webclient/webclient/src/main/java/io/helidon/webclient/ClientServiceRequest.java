...
/**
 * Request to SPI {@link io.helidon.webclient.spi.ClientService} that supports modification of the outgoing request.
 */
public interface ClientServiceRequest extends HttpRequest {
    ...
    /**
     * Configuration of the currently requested service.
     * This configuration is taken from "targets" section
     * and is dependent on invoked endpoint.
     * This may be used to override overall configuration of the client.
     *
